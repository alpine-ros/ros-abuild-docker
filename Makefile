...
dockerfiles: .dockerhub/kinetic.Dockerfile .dockerhub/melodic.Dockerfile .dockerhub/noetic.Dockerfile .dockerhub/noetic-alpine3.14.Dockerfile
...
.dockerhub/noetic-alpine3.14.Dockerfile: Dockerfile Makefile
	cp $< $@
	sed 's/\$${ALPINE_VERSION}/3.14/g' -i $@
	sed 's/\$${ROS_DISTRO}/noetic/g' -i $@
	sed 's/\$${ROS_PYTHON_VERSION}/3/g' -i $@
	sed '/^ARG \(ALPINE_VERSION\|ROS_\(DISTRO\|PYTHON_VERSION\)\)/d;' -i $@
	sed '1i # AUTOMATICALLY GENERATED: DO NOT EDIT THIS FILE BY HAND' -i $@
