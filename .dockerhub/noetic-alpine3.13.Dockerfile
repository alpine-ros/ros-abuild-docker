...
RUN echo "http://alpine-ros-experimental.dev-sq.work/v3.13/backports" >> /etc/apk/repositories \
  && echo "http://alpine-ros-experimental.dev-sq.work/v3.13/ros/noetic" >> /etc/apk/repositories \
